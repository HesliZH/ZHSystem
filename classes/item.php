...
class item extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('item', 'item', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// descricao
		$this->descricao = new DbField('item', 'item', 'x_descricao', 'descricao', '"descricao"', '"descricao"', 200, -1, FALSE, '"descricao"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->descricao->Sortable = TRUE; // Allow sort
		$this->fields['descricao'] = &$this->descricao;

		// ativo
		$this->ativo = new DbField('item', 'item', 'x_ativo', 'ativo', '"ativo"', 'CAST("ativo" AS varchar(255))', 11, -1, FALSE, '"ativo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->ativo->Sortable = TRUE; // Allow sort
		$this->ativo->DataType = DATATYPE_BOOLEAN;
		$this->ativo->Lookup = new Lookup('ativo', 'item', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "\"public\".\"item\"";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->id->setDbValue($conn->getOne("SELECT currval('item_id_seq'::regclass)"));
