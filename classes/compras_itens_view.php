 ...
 * Page class
 */
class compras_itens_view extends compras_itens
{
	...
	// Page object name
	public $PageObjName = "compras_itens_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "compras_itenslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "compras_itenslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "compras_itenslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
