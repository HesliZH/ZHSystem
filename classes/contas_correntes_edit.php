 ...
 * Page class
 */
class contas_correntes_edit extends contas_correntes
{
	...
	// Page object name
	public $PageObjName = "contas_correntes_edit";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("contas_correnteslist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("contas_correnteslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "contas_correnteslist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("contas_correnteslist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
