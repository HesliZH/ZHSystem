...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "ZH2019"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'fCRc3XuD4MmMQ4p9'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/ZH2019.css"); // Project stylesheet file name
...
$PROJECT_ID = "{82ACBA82-232B-41B1-A528-4DD4CC852004}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "localhost", "port" => 5432, "user" => "postgres", "pass" => "postgres", "db" => "zh", "schema" => "", "qs" => "\"", "qe" => "\"");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "hesli"); // Administrator user name
...
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "login_acesso");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "senha_acesso");
