 ...
 * Page class
 */
class contas_correntes_view extends contas_correntes
{
	...
	// Page object name
	public $PageObjName = "contas_correntes_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "contas_correnteslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "contas_correnteslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "contas_correnteslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
