 ...
 * Page class
 */
class compras_itens_edit extends compras_itens
{
	...
	// Page object name
	public $PageObjName = "compras_itens_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// unitario
			$this->unitario->setDbValueDef($rsnew, $this->unitario->CurrentValue, NULL, $this->unitario->ReadOnly);
