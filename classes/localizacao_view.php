 ...
 * Page class
 */
class localizacao_view extends localizacao
{
	...
	// Page object name
	public $PageObjName = "localizacao_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "localizacaolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "localizacaolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "localizacaolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
