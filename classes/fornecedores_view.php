 ...
 * Page class
 */
class fornecedores_view extends fornecedores
{
	...
	// Page object name
	public $PageObjName = "fornecedores_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "fornecedoreslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "fornecedoreslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "fornecedoreslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
