 ...
 * Page class
 */
class compras_view extends compras
{
	...
	// Page object name
	public $PageObjName = "compras_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "compraslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "compraslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "compraslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
