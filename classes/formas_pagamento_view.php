 ...
 * Page class
 */
class formas_pagamento_view extends formas_pagamento
{
	...
	// Page object name
	public $PageObjName = "formas_pagamento_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("formas_pagamentolist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "formas_pagamentolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "formas_pagamentolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "formas_pagamentolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("formas_pagamentolist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
