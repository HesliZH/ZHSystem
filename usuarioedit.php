...
fusuarioedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($usuario_edit->nome_completo->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuario_edit->login_acesso->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuario_edit->_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuario_edit->senha_acesso->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuario_edit->ativo->Required) { ?>
...
fusuarioedit.lists["x_ativo[]"] = <?php echo $usuario_edit->ativo->Lookup->toClientList() ?>;
fusuarioedit.lists["x_ativo[]"].options = <?php echo JsonEncode($usuario_edit->ativo->options(FALSE, TRUE)) ?>;
...
<?php if ($usuario->nome_completo->Visible) { // nome_completo ?>
	<div id="r_nome_completo" class="form-group row">
		<label id="elh_usuario_nome_completo" for="x_nome_completo" class="<?php echo $usuario_edit->LeftColumnClass ?>"><?php echo $usuario->nome_completo->caption() ?><?php echo ($usuario->nome_completo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuario_edit->RightColumnClass ?>"><div<?php echo $usuario->nome_completo->cellAttributes() ?>>
...
<?php if ($usuario->login_acesso->Visible) { // login_acesso ?>
	<div id="r_login_acesso" class="form-group row">
		<label id="elh_usuario_login_acesso" for="x_login_acesso" class="<?php echo $usuario_edit->LeftColumnClass ?>"><?php echo $usuario->login_acesso->caption() ?><?php echo ($usuario->login_acesso->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuario_edit->RightColumnClass ?>"><div<?php echo $usuario->login_acesso->cellAttributes() ?>>
...
<?php if ($usuario->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_usuario__email" for="x__email" class="<?php echo $usuario_edit->LeftColumnClass ?>"><?php echo $usuario->_email->caption() ?><?php echo ($usuario->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($usuario->senha_acesso->Visible) { // senha_acesso ?>
	<div id="r_senha_acesso" class="form-group row">
		<label id="elh_usuario_senha_acesso" for="x_senha_acesso" class="<?php echo $usuario_edit->LeftColumnClass ?>"><?php echo $usuario->senha_acesso->caption() ?><?php echo ($usuario->senha_acesso->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuario_edit->RightColumnClass ?>"><div<?php echo $usuario->senha_acesso->cellAttributes() ?>>
...
<?php if ($usuario->ativo->Visible) { // ativo ?>
	<div id="r_ativo" class="form-group row">
		<label id="elh_usuario_ativo" class="<?php echo $usuario_edit->LeftColumnClass ?>"><?php echo $usuario->ativo->caption() ?><?php echo ($usuario->ativo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuario_edit->RightColumnClass ?>"><div<?php echo $usuario->ativo->cellAttributes() ?>>
