...
class bens_edit extends bens
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// localizacao
			$this->localizacao->setDbValueDef($rsnew, $this->localizacao->CurrentValue, NULL, $this->localizacao->ReadOnly);
